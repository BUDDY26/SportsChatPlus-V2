    ...
    <div className="flex h-full">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {/* Live tab: 2-column game card grid */}
          {activeTab === "live" && (
            <div className="grid grid-cols-2 gap-2">
              {liveGames.map((game) => (
                <Link
                  key={game.id}
                  href="/dashboard/scores"
                  className="block rounded border border-border/50 bg-card p-3 transition-colors hover:border-primary/30 hover:bg-accent"
                >
                  {/* Card header */}
                  <div className="mb-3 flex items-center justify-between">
      ...
      <div className="hidden lg:flex w-72 flex-shrink-0 flex-col border-l border-border/40 bg-card overflow-y-auto">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={r.round} className="flex items-center justify-between py-0.5">
                <span
                  className={`text-[11px] ${
                    r.active ? "font-semibold text-foreground" : "text-muted-foreground"
                  }`}
                >
                  {r.round}
                </span>
                <span
                  className={`text-[10px] ${
                    r.active
                      ? "font-semibold text-sports-green"
